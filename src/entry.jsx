...
var Map = React.createClass({
  createMap: function (element) {
    ...
    var markers = [
            ...
            //Major Bosshardt
            [ 4.899873, 52.375477, 'This building, for a long time, was the workspace of<br><a href="http://en.wikipedia.org/wiki/Alida_Bosshardt">Major Bosshardt</a>' ],
            ...
            [ 4.895486, 52.374200, 'Johanna Borski was one of the richest people in her day (1764-1864), and one of the few female bankers. She was co-owner of the Dutch National Bank and saved another, laying the basis for what is now ABN-AMRO, one of the 15 largest banks in the world <br><a href="en.wikipedia.org/wiki/Johanna_Borski">wikipedia</a>' ],
            //Marretje Arents
            [ 4.900137, 52.373058, 'Marretje Arents was a rebellion leader, leading the pacher riots in 1748. After the rebellion she was sentenced to death by hanging and hung from the window of the Waag.<br><a href="en.wikipedia.org/wiki/Marretje_Arents">wikipedia</a>' ],
            //Haesje Claes
            [ 4.895986, 52.369303, 'The Oudemanhuispoort; the gate to the Old Mens House, founded by Haesje Claes, a woman who also founded the Old Womens House and was involved in the founding of the Burgerweeshuis (a city orphanage).<br><a href="resources.huygens.knaw.nl/vrouwenlexicon/lemmata/data/claes">Time to learn some Dutch</a>' ],
            //Johanna Reynvaan
            [ 4.894633, 52.368562, 'The Binnengasthuis, the first workplace of Johanna Reynvaan, who was at the basis of Dutch nursing, and later assistant-director of the Buitengasthuis on the Overtoom.<br><a href="books.google.nl/books?id=fk7K4WQVllYC&pg=PA92&lpg=PA92&dq=johanna+reynvaan&source=bl&ots=30b7SE3TPW&sig=kK0Se7lL1rldS-JMcFOwmJkqTuQ&hl=en&sa=X&ei=8AJXVayUOYmOsAHRnIC4BQ&ved=0CGYQ6AEwDw#v=onepage&q=johanna%20reynvaan&f=false">Nursing History Review</a>' ],
            //The Shakespeare Club
            [ 4.885188, 52.365276, 'Former Café De La Paix, where in September 1946 150 people gathered for the founding of the Shakespeare Club. It was the largest gathering of gay people in the country until then. The Shakespeare Club is now known as the C.O.C., the oldest surviving LGBT organisation.<br><a href="nl.wikipedia.org/wiki/Nederlandse_Vereniging_tot_Integratie_van_Homoseksualiteit_COC">Dutch wikipedia</a>' ],
            // April 1st 2001
            [ 4.902281, 52.368078, 'On  April 1st 2001, four couples were wed by mayor Job Cohen. Anne-Marie Thus and Hélène Faasen become the first two women in the world to legally marry.<br><a href="www.news.com.au/world/worlds-first-legally-wed-lesbian-couple-celebrates-their-10th-wedding-anniversary/story-e6frfkyi-1226030866529">Interview</a>' ],
			//Monument Deaf Jews
			[ 4.902281, 52.368078, 'The world remained deaf. The first monument for deaf victims of the Second World War.<br><img src="./dovenshoah.jpg"></img>' ],
            ...
            //River Kwai
            [ 99.532811, 14.022780, 'Well done! You looked beyond the frame you were given. This is the River Kwai, famous for its railway bridge built by Japan in WWII. But did you know that Thailand was never occupied? And that it was the only country in South East Asia to not be colonised?<br><a href="www.stickmanbangkok.com/ReadersSubmissions2014/reader8591.htm">Why Thailand Was Never Colonized</a>' ]
        ...
        var clickedIcon = L.Icon.extend({ options: { iconUrl: './marker-icon-red.png'} });	
